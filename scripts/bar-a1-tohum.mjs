...
export const K = {
  ...
  ONBUROMUD810: { rol: 'authenticated', sub: '11111111-0000-0000-0000-0000000000d4' }, // pms_folio TAM
  COST810: { rol: 'authenticated', sub: '11111111-0000-0000-0000-0000000000c1' },  // cost_control: sayim onaycisi (15c)
  QR: { rol: 'service_role' },
  ANON: { rol: 'anon' },
};
...
export const EK_TOHUM = `
  ...
  insert into public.roller (id, ad, seviye, kod, sira) values
    ...
    ('00000000-0000-0000-0000-00000000b014', 'On Buro Muduru', 'otel', 'onburo_mudur', 31),
  ...
  insert into public.yetki_matrisi (rol_id, modul_id, yetki) values
    ...
    ('00000000-0000-0000-0000-00000000b014', '00000000-0000-0000-0000-00000000a003', 'tam'),
  ...
  insert into auth.users (id, email) values
    ...
    ('11111111-0000-0000-0000-0000000000d4', 'onburomud810@test.local'),
    ('11111111-0000-0000-0000-0000000000c1', 'cost810@test.local');
  insert into public.kullanicilar (id, auth_user_id, ad, rol, otel_id, aktif, rol_id) values
    ...
    ('33333333-0000-0000-0000-0000000000d4', '11111111-0000-0000-0000-0000000000d4', 'OnBuroMud 810', 'muhasebe_calisani', '810', true, '00000000-0000-0000-0000-00000000b014'),
    ('33333333-0000-0000-0000-0000000000c1', '11111111-0000-0000-0000-0000000000c1', 'Cost 810', 'cost_control', '810', true, '00000000-0000-0000-0000-00000000b015');`;
