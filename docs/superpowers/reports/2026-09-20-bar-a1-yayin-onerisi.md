...
| Öğe | Değer |
|---|---|
| Kaynak dal | `bar-a1` — bugünkü uç: **`d31fb50`** (bu rapor işlendikten sonra güncellenir) |
| Taban | `origin/main` = **`9c06661`** (bugün `git fetch` ile doğrulandı: hâlâ ata) |
| Commit sayısı | 32 (`9c06661..d31fb50`) |
...
| 4 | **Ekranlar** | `main` → `d31fb50` (fast-forward); ardından sayfa açılış duman testi |
